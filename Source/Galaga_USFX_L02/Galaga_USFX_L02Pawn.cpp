...
{	
	static ConstructorHelpers::FObjectFinder<UStaticMesh> ShipMesh(TEXT("StaticMesh'/Game/StarterContent/Props/SM_Couch.SM_Couch'"));
	...
	static ConstructorHelpers::FObjectFinder<USoundBase> FireAudio(TEXT("SoundWave'/Game/StarterContent/Audio/Explosion01.Explosion01'"));
	...
	// Creates a spawn component
	ControlSpawnBomba = NewObject<Ucomponente_spawn_bombas>(this, TEXT("componente_spawn_bombas"));
...
void AGalaga_USFX_L02Pawn::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	// Bind fire event
	PlayerInputComponent->BindAction("dispararbomba", IE_Pressed, this, &AGalaga_USFX_L02Pawn::disparar);
}
...
void AGalaga_USFX_L02Pawn::disparar()
{
